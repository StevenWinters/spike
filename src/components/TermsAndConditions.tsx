const TermsAndConditions = () => {
  return (
    <section className="block block--dark container terms">
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to Spike!!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Spike!'s Website, located at spike.vercel.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Spike! if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of ph. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing Spike!, you agreed to use
        cookies in agreement with the Spike!'s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Spike! and/or its licensors own the
        intellectual property rights for all material on Spike!. All
        intellectual property rights are reserved. You may access this from
        Spike! for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Spike!</li>
        <li>Sell, rent or sub-license material from Spike!</li>
        <li>Reproduce, duplicate or copy material from Spike!</li>
        <li>Redistribute content from Spike!</li>
      </ul>
      ...
      <p>
        ...
        Spike! does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Spike!,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Spike! shall not be liable for the
      ...
      <p>
        Spike! reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Spike! a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Spike!; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Spike!. Please include your name, your organization name,
      ...
      <p>
        No use of Spike!'s logo or other artwork will be allowed for linking
